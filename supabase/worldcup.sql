...
alter table public.worldcup_matches
  ...
  add column if not exists result_pen_home int,
  add column if not exists result_pen_away int,
...
begin
  ...
  values
    ...
    ('r16_1','r16','16강 1경기','팀 A','팀 B'),
    ('r16_2','r16','16강 2경기','팀 C','팀 D'),
    ('r16_3','r16','16강 3경기','팀 E','팀 F'),
    ('r16_4','r16','16강 4경기','팀 G','팀 H'),
    ('r16_5','r16','16강 5경기','팀 I','팀 J'),
    ('r16_6','r16','16강 6경기','팀 K','팀 L'),
    ('r16_7','r16','16강 7경기','팀 M','팀 N'),
    ('r16_8','r16','16강 8경기','팀 O','팀 P'),
